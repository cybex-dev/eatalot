...
/*4.2*/import views.html.Global.Static.essentials
    ...
    """),_display_(/*13.6*/helper/*13.12*/.form(action = controllers.User.routes.CustomerController.doCompleteRegistration())/*13.95*/ {_display_(Seq[Any](format.raw/*13.97*/("""
        ...
        <div class="container input-container">
            ...
            <div class="input-group input-container">
                ...
                """),format.raw/*35.17*/("""<br/>
                """),_display_(/*36.18*/helper/*36.24*/.checkbox(userProfile("isCommunity"), '_name -> "Reside in an apartment/complex", '_id -> "chkComm")),format.raw/*36.124*/("""
                """),_display_(/*37.18*/helper/*37.24*/.inputText(userProfile("communityName"), '_name -> "Community Name", '_id -> "commName")),format.raw/*37.112*/("""
