        ...
        """),format.raw/*72.9*/("""<div class="row pad-botm">
            <div class="col-md-12">
                ...
                <div class="margin-left-large">
                    <a href=""""),_display_(/*77.31*/controllers/*77.42*/.User.routes.AdminController.addMeal()),format.raw/*77.80*/("""" class="btn btn-success add-button text-bold">
                        New Meal<img class="small-icon align-button-contents" src=""""),_display_(/*78.85*/routes/*78.91*/.Assets.versioned("images/icons/add.png")),format.raw/*78.132*/("""">
                    </a>
                </div>
                <br/>
            </div>
        </div>
    """),_display_(/*84.6*/table),format.raw/*84.11*/("""
    """)))};
Seq[Any](format.raw/*7.29*/("""
    ...
    """),_display_(/*87.6*/masterpage/*87.16*/.apply(" :: Manage Meals", bodyContent)))
      }
    }
  }
