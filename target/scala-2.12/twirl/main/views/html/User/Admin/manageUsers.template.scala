...
object manageUsers extends _root_.play.twirl.api.BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,_root_.play.twirl.api.Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with _root_.play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
Seq[Any](format.raw/*5.17*/("""
    """),format.raw/*6.5*/("""<h1>Manage Users</h1>
""")))};
Seq[Any](format.raw/*3.4*/("""

"""),format.raw/*7.2*/("""

"""),_display_(/*9.2*/masterpage/*9.12*/.apply(" :: Manage Users", bodyContent)))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Thu Oct 12 20:15:45 SAST 2017
