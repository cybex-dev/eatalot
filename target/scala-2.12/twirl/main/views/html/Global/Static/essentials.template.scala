        ...
        """),_display_(/*14.10*/for(key <- Array("danger","warning","success","info")) yield /*14.64*/ {_display_(Seq[Any](format.raw/*14.66*/("""
            """),_display_(/*15.14*/if(flash().containsKey(key))/*15.42*/ {_display_(Seq[Any](format.raw/*15.44*/("""
                """),format.raw/*16.17*/("""<div class="alert alert-"""),_display_(/*16.42*/key),format.raw/*16.45*/("""">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">"""),_display_(/*17.88*/flash/*17.93*/.get(key).toString),format.raw/*17.111*/("""<i class="glyphicon glyphicon-remove"></i></a>
                </div>
            """)))}),format.raw/*19.14*/("""
        """)))}),format.raw/*20.10*/("""
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/dylan/Documents/project/goaway/eatalot-master (backup)/Order-Management-Devel/app/views/Global/Static/essentials.scala.html
                  HASH: 339c98f541965ba94065fdefd3d4b3163b614e73
                  MATRIX: 665->1|711->41|740->64|1087->89|1239->170|1257->180|1337->184|1373->194|1385->198|1413->206|1449->216|1468->227|1496->235|1533->245|1597->288|1626->301|1643->309|1724->313|1761->323|1831->377|1871->379|1912->393|1949->421|1989->423|2034->440|2086->465|2110->468|2227->558|2241->563|2281->581|2395->664|2436->674|2473->684|2513->703|2550->713|2582->724|2619->734|2642->748|2671->756|2716->163|2749->294|2782->762|2815->768|2895->821|2910->827|2949->845|2986->855|2999->859|3044->883|3081->893|3097->900|3126->908|3163->918|3198->932|3230->937
